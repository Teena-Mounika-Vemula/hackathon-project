...
const LoginPage = ({ navigateTo }) => {
    ...
    const [subHeading, setSubHeading] = useState('Sign in to continue your ocean mission');
            ...
            <div className="min-h-screen flex flex-col">
                ...
                <nav className="bg-sky-500 text-white shadow-lg z-50">
                    <div className="container mx-auto px-4 py-3 flex justify-between items-center">
                        ...
                        <div className="hidden md:flex space-x-8">
                            ...
                            <button onClick={() => navigateTo('home')} className="hover:text-sky-100 transition">Home</button>
                        ...
                        <div className="md:hidden">
                            <button id="menu-toggle" className="focus:outline-none" onClick={() => console.log("Mobile menu toggle not implemented on login page")}>
                        ...
                        <div className="p-8">
                            ...
                            <div className="flex justify-center mb-8">
                                <div className="relative inline-flex items-center">
                                    <span className={`mr-3 text-sm font-medium ${isVolunteer ? 'text-sky-600' : 'text-gray-400'}`}>Volunteer</span>
                                    <div className="relative">
                                        ...
                                        />
                                        <label htmlFor="user-toggle" className={`toggle-label block overflow-hidden h-6 rounded-full bg-gray-300 cursor-pointer w-12 transition-all duration-300 ease-in-out ${!isVolunteer ? 'bg-sky-500' : ''}`}></label>
                                    </div>
                                    <span className={`ml-3 text-sm font-medium ${!isVolunteer ? 'text-sky-600' : 'text-gray-400'}`}>Organizer</span>
                                </div>
                            </div>
                            
                            {isVolunteer ? (
                                <div id="volunteer-form" className="login-form-container">
                                    <form onSubmit={handleVolunteerLogin}> {/* Added onSubmit handler */}
                                        <div className="mb-4">
                                            <label htmlFor="volunteer-email" className="block text-gray-700 text-sm font-medium mb-2">Email Address</label>
                                            <input
                                                type="email"
                                                id="volunteer-email"
                                        ...
                                        <div className="mb-6">
                                            <label htmlFor="volunteer-password" className="block text-gray-700 text-sm font-medium mb-2">Password</label>
                                            <input
                                                type="password"
                                            ...
                                            <div className="flex justify-end mt-2">
                                                <a href="#" className="text-sm text-sky-600 hover:text-sky-800 transition">Forgot password?</a>
                                            </div>
                                        </div>
                                        
                                        <button type="submit" className="w-full bg-sky-500 hover:bg-sky-600 text-white font-bold py-3 px-4 rounded-lg shadow transition">
                                            Sign In
                                        </button>
                                        ...
                                        <div className="text-center mt-6">
                                            <p className="text-gray-600">
                                                ...
                                                <button type="button" onClick={() => navigateTo('signup')} className="text-sky-600 hover:text-sky-800 font-medium transition ml-1">Sign up now</button>
                                            </p>
                                        </div>
                                    </form>
                                    ...
                                    <div className="text-center mt-4">
                                        <p className="text-sm text-gray-500">Join our community of 10,000+ volunteers</p>
                                    </div>
                                </div>
                            ) : (
                                <div id="organizer-form" className="login-form-container">
                                    <form onSubmit={handleOrganizerLogin}> {/* Added onSubmit handler */}
                                        ...
                                        <div className="mb-6">
                                            <label htmlFor="organizer-password" className="block text-gray-700 text-sm font-medium mb-2">Password</label>
                                            <input
                                                type="password"
                                        ...
                                        <button type="submit" className="w-full bg-sky-600 hover:bg-sky-700 text-white font-bold py-3 px-4 rounded-lg shadow transition">
                                    ...
                                    <div className="text-center mt-4">
                                        <p className="text-sm text-gray-500">Organizer access is restricted to approved team leaders</p>
                                        <p className="text-sm text-gray-500 mt-1">Need access? <a href="#" className="text-sky-600 hover:text-sky-800 transition">Contact admin</a></p>
                                    </div>
                                </div>
                            )}
                        </div>
                ...
                <footer className="bg-sky-900 text-white py-6">
                    <div className="container mx-auto px-4 text-center">
                        ...
                        <p className="text-sky-200 text-sm">Join our mission to clean beaches and protect marine ecosystems</p>
                        ...
                        <p className="text-xs text-sky-300 mt-4">&copy; 2023 Beach Warriors. All rights reserved.</p>
                    </div>
                </footer>
            </div>
        </>
